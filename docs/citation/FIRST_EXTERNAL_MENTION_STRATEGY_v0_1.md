...
3. Reference the local MCP-style stub in `mcp/ecl_tool_spec.json` and `mcp/ecl_server_stub.py`.
...
runtime trace -> ECL object -> validate -> replay -> evidence hash.
