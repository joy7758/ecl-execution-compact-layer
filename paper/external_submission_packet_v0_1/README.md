# ECL v0.1 External Submission Packet

Status: external_packet_ready_joss_immediate_submission_not_recommended

Date prepared: 2026-06-28

This packet excludes internal repair notes and keeps only public-facing paper, metadata, experiment, GitHub review-surface, and readiness materials.
...
```text
internal_repair_notes_included=false
joss_submission_performed=false
