...
| 2026-06-30 | pending commit | external forum posting handoff | Prepared LangChain Forum and MCP Discussions handoff copy with current `make demo` hashes and explicit not-posted boundaries | forum_posting_handoff_prepared |
