...
| 2026-06-30 | `db2f17cf0ea7dc062f55a821633a3090108b1ef2` | external action queue test gate | Added unit tests for queue order, boundary flags, referenced packets, artifact hashes, and agent-index exposure | external_action_queue_test_gate_added |
